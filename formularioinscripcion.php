...
function habi() {
    if(document.getElementById("idTipo").value =="1"||document.getElementById("idTipo").value =="2" ||document.getElementById("idTipo").value =="3" ){
...
<div class="container">
    <div class="row">
     <form class="form-horizontal" id="Inscripciones" method="post" action="Inscripciones.php" enctype="multipart/form-data">
            ...
            <div class="col-sm-4">
                ...
                <option>Seleccione una Opci&oacuten...</option>
                    <?php 
                        ...
                        $result2 = mysql_query("SELECT * FROM tipo where idtipo='1' or idtipo='2' or idtipo='3' or idtipo='4'", $link); 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <select name="Rh1" id="Rh1" class="form-control">
                    <option>Seleccione una Opci&oacuten...</option>
                    <option>A</option>
                    <option>B</option>
                    <option>O</option>
        ...
        <div class="form-group">
            <label class="control-label      col-sm-4" for="Prénom">Eps :</label>                     
            <div class="col-sm-4">
                <select name="eps" id="eps" class="form-control" >
                    <option>Seleccione una Opci&oacuten...</option>
                    <?php 
                        $result3 = mysql_query("SELECT * FROM seguro", $link);
                        while($row3 = mysql_fetch_array($result3)){
                            echo'<OPTION VALUE="'.$row3['idseguro'].'">'.$row3['nombre_seguro'].'</OPTION>';
                        }
                    ?>
                </select> 
            </div>
    ...
    <?php 
        $result4 = mysql_query("SELECT * FROM cursos where Tipo= 'Deportes'", $link);
        while($row4 = mysql_fetch_array($result4)){
