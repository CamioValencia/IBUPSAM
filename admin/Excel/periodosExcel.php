<?php
	...
	$objPHPExcel->getActiveSheet()->setCellValue('C6', 'idPersonas');
	...
	while($rows = $resultado->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C'.$fila, $rows['idPersonas']);
