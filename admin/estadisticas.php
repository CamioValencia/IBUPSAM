...
<head>
    ...
    <title>Bienestar Universitario | Estadística </title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 text-center">
                <a title="Grafico" href="./graficopastel.php" ><img class="img-circle img-responsive img-center" src="../img/estadisticas.png" alt="" style="width: 253px; height: 222px;"></a>
                <h3>Grafico de pastel </h3>                             
            </div>
            <!--<div class="col-lg-4 col-sm-6 text-center">
                <a title="REGISTRO Usuarios" href="cuentas/crear_usuario.php" ><img class="img-circle img-responsive img-center" src="../img/agregar.png" alt="" style="width: 253px; height: 222px;"></a>
