  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <tbody>
      ...
      <?php
          ...
          $consul=mysql_query("SELECT * FROM personas, detinscripcion WHERE personas.Cc = detinscripcion.Cedula AND detinscripcion.Actividad='MusicaVocal'")or die(mysql_error());
